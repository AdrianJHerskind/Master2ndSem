<?php
session_start();
	$thisPage = "schaefer2.php";
	if(!array_key_exists("ip",$_SESSION))
	{
		header("Location: ../index.php");
	}
	else if(strcmp($_SESSION["blockSchaefer2"], "true") == 0)
	{
...
<div class="container.fluid" style="margin-top: 10px;">
	<div class="row">
		...
		<div class="col-lg-8 text-center">
			<p>Thank you for playing the game. We hope you enjoyed it.</p>
			<p>Please fill out this final survey where you rate the robot again after experiencing the interaction with it.</p>
		</div>
...
<form method="post" action="handleFormData.php" name="schaefer">
	<input type="hidden" name="whichForm" value="schaefer2">
